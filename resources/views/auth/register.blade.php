    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input class="block mt-1 w-full" id="email" type="email" name="email" :value="old('email')" required autocomplete="username" />
            </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-2">
                                {!! __('I agree to the :terms_of_service and :privacy_policy', [
                                        'terms_of_service' => '<a target="_blank" href="'.route('terms').'" class="underline text-sm text-[var(--ink-soft)] hover:text-[var(--gold-deep)]">'.__('Terms of Service').'</a>',
                                        'privacy_policy' => '<a target="_blank" href="'.route('policy').'" class="underline text-sm text-[var(--ink-soft)] hover:text-[var(--gold-deep)]">'.__('Privacy Policy').'</a>',
                                ]) !!}
                            </div>
                        </div>
                    </x-jet-label>
